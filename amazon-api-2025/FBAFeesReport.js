// // File: FBAFeesReport.gs
// Info: 
// FBA Payments Reports
// FBA Fee Preview Report
// reportType Value: GET_FBA_ESTIMATED_FBA_FEES_TXT_DATA

// Role: Pricing, Amazon Fulfillment
...
// Contains the estimated Amazon Selling and Fulfillment Fees for the seller's FBA inventory with active offers. The content is updated at least once every 72 hours. To successfully generate a report, specify the StartDate parameter for a minimum 72 hours prior to NOW and EndDate to NOW.
...
// expected-efn-fulfilment-fee-per-unit-uk
// expected-efn-fulfilment-fee-per-unit-de
// expected-efn-fulfilment-fee-per-unit-fr
// expected-efn-fulfilment-fee-per-unit-it
// expected-efn-fulfilment-fee-per-unit-es
